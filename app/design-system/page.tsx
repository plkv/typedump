      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '48px 24px 120px' }}>
        ...
        <Section title="Typography">
          ...
          <div style={{ marginTop: 24, borderRadius: 12, border: '1px solid var(--gray-brd-prim)', overflow: 'hidden' }}>
            ...
            {[
              { cls: '.text-sidebar-title', sample: 'Sidebar title', spec: 'Geist 14px/14px 500, ss03+cv06+cv11' },
              { cls: '.text-font-name',     sample: 'Font name',     spec: 'Geist 14px/20px 500, ss03+cv06+cv11' },
              { cls: '.text-menu',          sample: 'Menu item',     spec: 'Geist 14px/20px 500 (same as .text-font-name)' },
              { cls: '.text-author',        sample: 'by Some Author', spec: 'Geist 14px/20px 500 · color: --gray-cont-tert' },
